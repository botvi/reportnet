    ...
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Login Mikrotik</h3>
                    <p class="text-subtitle text-muted">Login Mikrotik</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        <h4 class="mt-3">Tambah Data Mikrotik</h4>
                        <form action="{{ route('mikrotik.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
