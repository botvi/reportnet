                            ...
                            @foreach ($pengaduan as $index => $pengaduan)
                                @if ($pengaduan->user->id === Auth::id())
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary btn-sm" onclick="showDescription('{{ $pengaduan->deskripsi }}')">Lihat Aduan</button>
                                            
                                            @if ($pengaduan->status !== 'Proses' && $pengaduan->status !== 'Selesai')
                                                <button type="button" class="btn btn-success btn-sm" onclick="showEditForm('{{ $pengaduan->id }}', '{{ $pengaduan->deskripsi }}')">
