...
@yield('style')
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('web/public') }}/assets/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('web/public') }}/assets/img/favicons/favicon-16x16.png">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex py-3 py-lg-0">
                        @auth
                            <a href="/profil" class="btn btn-outline-primary rounded-pill order-0"><i class="bi bi-person-circle"></i> &nbsp; &nbsp; &nbsp;Edit Profil</a>
