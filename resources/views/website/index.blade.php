...
@section('content')
      ...
      <!-- <section> begin ============================-->
        <section class="pb-6">
          ...
          <div class="container">
            <div class="row flex-center">
              <div class="col-lg-6 col-md-5 order-md-1"><img class="img-fluid" src="{{ asset('web/public') }}/assets/img/illustrations/1.png" alt="" /></div>
              <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
                <h1 class="fw-medium">Kendala Jaringan ?<br />Ajukan Pengaduan <span class="fw-bold"> Sekarang.</span></h1>
                <p class="mt-3 mb-4">Kami memahami bahwa kadang-kadang, masalah jaringan dapat menghambat aktivitas Anda. Jangan khawatir, tim kami siap membantu! Jika Anda mengalami kendala jaringan atau memiliki pertanyaan teknis, silakan sampaikan pengaduan Anda. Kami berkomitmen untuk memberikan solusi secepat mungkin, sehingga Anda dapat melanjutkan aktivitas online Anda tanpa gangguan. Terima kasih atas kesabaran dan kerjasama Anda.</p><a class="btn btn-lg btn-danger hover-top btn-glow" href="/pengaduan">Get Started </a>
              </div>
            </div>
          </div>
          <!-- end of .container-->
        ...
        <section class="py-4">
          ...
          <div class="container">
            <div class="card py-5 border-0 shadow-sm">
                <div class="card-body">
                    <div class="row justify-content-center text-center"> <!-- Tambahkan class justify-content-center dan text-center di sini -->
                        <div class="col-4">
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-7 col-lg-5 text-center text-md-start">
                ...
                <p> Kami Menyediakan Banyak
                  Layanan yang Dapat Anda Gunakan
                  Anda dapat menjelajahi Layanan yang kami sediakan dengan menyenangkan dan Kepuasan masing-masing pada setiap layanannya.</p>
                <div class="d-flex">
                  ...
                  <p class="ms-2">Perlindungan online yang kuat.</p>
                </div>
                <div class="d-flex">
                  <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                  </svg>
                  <p class="ms-2">Internet tanpa batas.</p>
                </div>
                <div class="d-flex">
                  <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
                  </svg>
                  <p class="ms-2">VPN yang sangat canggih.</p>
                </div>
                <div class="d-flex">
                  <svg class="bi bi-check-circle-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2FAB73" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>
        ...
        <section class="bg-100 py-7 text-center">
          ...
          <div class="container">
            <div class="row justify-content-center">
              ...
              <div class="pt-8"><img class="img-fluid" src="{{ asset('web/public') }}/assets/img/gallery/map.png" alt="" /></div>
            </div>
          </div>
          <!-- end of .container-->
                  ...
                  <div class="row h-100">
                      ...
                      <div class="card h-100">
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="{{ asset('web/public') }}/assets/img/gallery/user-1.png" alt="" />
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="{{ asset('web/public') }}/assets/img/gallery/user-2.png" alt="" />
                              <div class="flex-1 ms-3">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="{{ asset('web/public') }}/assets/img/gallery/user-3.png" alt="" />
                              <div class="flex-1 ms-3">
                                <h6 class="mb-0 fs--1 text-1000 fw-medium">Viezh Robert</h6>
        ...
        <section class="bg-200 pt-9 pb-0">
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle" src="{{ asset('web/public') }}/assets/img/icons/logo.png" alt="" width="30" /><span class="d-inline-block text-1000 fs-1 ms-2 fw-medium lh-base">Lasles<span class="fw-bold">VPN</span></span></a>
